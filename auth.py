...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .form-label { display: block; font-size: 14px; font-weight: 600; color: #1a3a0d; margin-bottom: 10px; letter-spacing: 0.2px; }
        ...
        .form-input:focus { outline: none; border-color: #2d5016; box-shadow: 0 0 0 3px rgba(45, 80, 22, 0.15); background: #fff; }
        .btn { width: 100%; padding: 14px; background: #2d5016; color: #fff; border: none; border-radius: 8px; font-size: 15px; font-weight: 600; cursor: pointer; margin-top: 12px; letter-spacing: 0.3px; }
        .btn:hover { background: #1f3910; transform: translateY(-2px); box-shadow: 0 6px 20px rgba(45, 80, 22, 0.4); } .btn { transition: all 0.2s ease; }
        ...
        .footer-link a { color: #2d5016; text-decoration: none; font-weight: 600; }
...
<body>
    <div class="login-container">
        <div style="text-align: center; margin-bottom: 40px;">
            ...
            <div style="font-size: 32px; font-weight: 700; color: #1a3a0d; letter-spacing: -0.8px;">Welcome</div>
        </div>
        <div class="card">
