...
check "No hardcoded secrets in app.py" "! grep -q 'SECRET_KEY.*=.*['\\\"][^o]' app.py || grep -q 'SECRET_KEY.*=.*os.getenv' app.py"
check "No hardcoded API secrets" "! grep -q 'SHOPIFY_API_SECRET.*=.*['\\\"][^o]' app.py shopify_oauth.py || grep -q 'SHOPIFY_API_SECRET.*=.*os.getenv' app.py shopify_oauth.py"
