...
check "OAuth blueprint registered" "grep -q 'oauth_bp' app_factory.py"
check "Billing blueprint registered" "grep -q 'billing_bp' app_factory.py"
check "GDPR blueprint registered" "grep -q 'gdpr_bp' app_factory.py"
check "Webhook blueprint registered" "grep -q 'webhook_shopify_bp' app_factory.py"
...
check "API version 2025-10 in app.json" "grep -q '\"api_version\": \"2025-10\"' app.json"
check "API version 2025-10 in shopify.app.toml" "grep -q 'api_version = \"2025-10\"' shopify.app.toml"
...
check "SECRET_KEY uses os.getenv" "grep -q 'SECRET_KEY.*os.getenv' app_factory.py"
check "API Secret uses os.getenv" "grep -q 'SHOPIFY_API_SECRET.*os.getenv' shopify_oauth.py"
